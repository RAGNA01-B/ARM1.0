...
const handler = async (m, {conn, text, participants, isOwner, isAdmin}) => {
  try {
    ...
    const htextos = `${text ? text : '*Lider Queremos VS*'}`;
    if ((isMedia && quoted.mtype === 'imageMessage') && htextos) {
      ...
      await conn.relayMessage(m.chat, {extendedTextMessage: {text: `${masss}\n${htextos}\n`, ...{contextInfo: {mentionedJid: users, externalAdReply: {thumbnail: imagen1, sourceUrl: 'https://whatsapp.com/channel/0029VaxGHbk0VycH76kD4M1w'}}}}}, {});
    }
  }
};
